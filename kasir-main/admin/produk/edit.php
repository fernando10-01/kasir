...
<head>
    ...
    <title>Edit Produk - Kasir Fernando</title>
        ...
        <div class="col-md-6 mx-auto mt-4">
            ...
            <div class="glass-card overflow-hidden">
                ...
                <div class="card-body p-4 p-md-5">
                    <div class="mb-4">
                        <h4 class="fw-extrabold text-dark-custom mb-1">Edit Produk</h4>
                        <p class="text-muted small">ID Produk: <span class="badge bg-light" style="color: var(--dark-color);">PRD-<?= $d['ProdukID']; ?></span></p>
                    </div>
                    ...
                    <form id="formEdit" action="proses_edit.php" method="POST">
                        ...
                        <div class="d-grid gap-2 mt-2">
                            <button type="button" onclick="confirmEdit()" class="btn text-white fw-bold btn-update py-3">
