...
<head>
    ...
    <title>Tambah Produk - Kasir Fernando</title>
        ...
        <div class="col-md-6 mx-auto mt-4">
            ...
            <nav aria-label="breadcrumb" class="mb-3">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active fw-bold text-dark-custom" aria-current="page">Tambah Baru</li>
              </ol>
            </nav>
                ...
                <div class="card-body p-4 p-md-5">
                    <div class="text-center mb-4">
                        <div class="bg-primary-light d-inline-block p-3 rounded-circle mb-3">
                            <i class="fas fa-plus-circle fa-2x text-primary-custom"></i>
                        </div>
                        <h4 class="fw-extrabold text-dark-custom mb-1">Tambah Produk Baru</h4>
                    ...
                    <form id="formTambah" action="proses_tambah.php" method="POST">
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-text border-end-0" style="border-radius: 12px 0 0 12px;"><i class="fas fa-tag text-muted"></i></span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 mb-4">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text border-end-0" style="border-radius: 12px 0 0 12px;"><i class="fas fa-cubes text-muted"></i></span>
