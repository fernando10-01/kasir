...
<head>
    ...
    <title>Tambah User - Kasir Fernando</title>
                ...
                <div class="glass-card overflow-hidden">
                    ...
                    <div class="card-body p-4 p-md-5">
                        <div class="mb-4 text-center">
                            <div class="bg-primary-light d-inline-block p-3 rounded-circle mb-3">
                                <i class="fas fa-user-plus fa-2x text-primary-custom"></i>
                            </div>
                            <h4 class="fw-extrabold mb-1" style="color: var(--dark-color);">Registrasi User</h4>
                            <p class="text-muted small">Buat akun baru untuk akses sistem Kasir Fernando</p>
                        </div>
                        ...
                        <form action="proses_tambah.php" method="POST">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text border-end-0" style="border-radius: 12px 0 0 12px;"><i class="fas fa-user text-muted"></i></span>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text border-end-0" style="border-radius: 12px 0 0 12px;"><i class="fas fa-lock text-muted"></i></span>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text border-end-0" style="border-radius: 12px 0 0 12px;"><i class="fas fa-id-badge text-muted"></i></span>
