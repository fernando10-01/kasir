...
<head>
    ...
    <title>Edit User - Kasir Fernando</title>
                ...
                <div class="glass-card overflow-hidden">
                    ...
                    <div class="card-body p-4 p-md-5">
                        <div class="mb-4 text-center">
                            <h4 class="fw-extrabold mb-1" style="color: var(--dark-color);">Edit Petugas</h4>
                        ...
                        <form method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text border-end-0" style="border-radius: 12px 0 0 12px;"><i class="fas fa-user-shield text-muted"></i></span>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text border-end-0" style="border-radius: 12px 0 0 12px;"><i class="fas fa-key text-muted"></i></span>
