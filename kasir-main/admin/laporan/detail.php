...
<head>
    ...
    <title>Detail Transaksi #<?= $id; ?> - Kasir Fernando</title>
        ...
        <div class="container-fluid p-4">
            <div class="col-md-8 mx-auto">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div class="text-end">
                        <h4 class="fw-extrabold m-0 text-dark-custom">TRX-#<?= str_pad($id, 5, "0", STR_PAD_LEFT); ?></h4>
                        <span class="badge badge-success-custom rounded-pill px-3">Transaksi Selesai</span>
                    </div>
                </div>
                    ...
                    <div class="card-body p-4 p-md-5">
                        <div class="row invoice-head pb-4 mb-4">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="fw-bold m-0 text-dark-custom"><?= $data['NamaPelanggan']; ?></h5>
                            ...
                            <div class="col-sm-6 text-sm-end">
                                ...
                                <h5 class="fw-bold m-0 text-dark-custom">
                        ...
                        <div class="table-responsive mb-4">
                            <table class="table table-custom align-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="ps-0 py-3">
                                            <div class="fw-bold text-dark-custom"><?= $d['NamaProduk']; ?></div>
                                            <small class="text-muted">SKU: PROD-<?= $d['ProdukID']; ?></small>
                                        </td>
                                        <td class="text-center text-muted">Rp <?= number_format($d['Harga'], 0, ',', '.'); ?></td>
                                        <td class="text-center">
                                            <span class="badge rounded-pill bg-light border px-3" style="color: var(--dark-color);">x<?= $d['JumlahProduk']; ?></span>
                                        </td>
                                        <td class="text-end pe-0 fw-bold text-dark-custom">Rp <?= number_format($d['Subtotal'], 0, ',', '.'); ?></td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
                            ...
                            <div class="col-md-5">
                                <div class="bg-light p-4 rounded-4">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <span class="fw-extrabold text-dark-custom">TOTAL AKHIR</span>
                                        <h4 class="fw-extrabold m-0 text-primary-custom">Rp <?= number_format($data['TotalHarga'], 0, ',', '.'); ?></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-5 text-center p-3 border rounded-4 border-dashed bg-white bg-opacity-50">
                            <p class="small text-muted mb-0">
                                <i class="fas fa-info-circle me-1"></i> Terima kasih telah berbelanja di <strong>Kasir Fernando</strong>. 
